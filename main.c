#pragma config(Sensor, S1,     line,           sensorEV3_Color, modeEV3Color_RGB_Raw)
#pragma config(Sensor, S2,     gyro,           sensorEV3_Gyro)
#pragma config(Motor,  motorB,          left,          tmotorEV3_Large, PIDControl, driveLeft, encoder)
#pragma config(Motor,  motorC,          right,         tmotorEV3_Large, PIDControl, driveRight, encoder)
//*!!Code automatically generated by 'ROBOTC' configuration wizard               !!*//

#define LS_THRESHOLD  50
...
task sensorRead() {
	...
	while (true) {
		getColorRawRGB(line, redValue, greenValue, blueValue);
		colorRead = blueValue;
		...
		if (colorRead < LS_THRESHOLD && lastRead > LS_THRESHOLD) {
